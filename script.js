...
function loadCursosContentDirectly() {
    ...
    cursosContainer.innerHTML = `
        <div class="rounded-container mb-4">
            ...
            <div class="mb-5">
    <h4 class="section-title"><i class="fas fa-book-open"></i> Paquetes ClassCloud℠</h4>
    <p class="mb-4">Colección de contenido exclusivo en distintas áreas</p>
    <div class="row g-4">
        <!-- Producto -->
        <div class="col-md-6">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="product-images">
                            <img src="https://raw.githubusercontent.com/emiliocolor/clientes/bdb2d50401f2282e266d63b02a7abb71197dc173/img_productos_servicios/ultra_mega_pack-removebg-preview.png" alt="ULTRA MEGA PACK Classcloud sm" class="img-fluid rounded mb-2">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h5>ULTRA MEGA PACK</h5>
                        <p class="small">Accede a los 15,000 cursos que vendemos más 95,000 recursos digitales. Contiene:</p>
                        <ul class="small">
                            <li><strong>Categoría:</strong> Cursos y Formación</li>
                            <li><strong>Categoría:</strong> Libros y Audiolibros</li>
                            <li><strong>Categoría:</strong> Programas y Tutoriales</li>
                            <li><strong>Categoría:</strong> Videojuegos</li>
                            <li><strong>Categoría:</strong> Entretenimiento</li>
                            <li><strong>Categoría:</strong> Recursos Editables</li>
                            <li><strong>Categoría:</strong> Paquetes Sorpresa</li>
                        </ul>
                        <p class="product-price fw-bold mt-2">$99.00 MXN</p>
                        <div class="d-flex gap-2">
                            <button class="btn btn-primary btn-sm add-to-cart" data-type="product" data-id="c99" data-name="ULTRA MEGA PACK Classcloud sm" data-price="99.00">Agregar al carrito</button>
                            <a href="https://wa.me/525625377747?text=Hola,%20estoy%20interesado%20en%20el%20ULTRA%20MEGA%20PACK%20Classcloud%20sm%20(99.00%20MXN)%20de%20EmilioColor®" class="btn btn-success-gradient btn-sm" target="_blank">Comprar ahora</a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
            <!-- Bonus de regalo como producto separado -->
    <div class="col-md-6">
        <div class="card tool-card p-3">
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="product-images">
                        <img src="https://raw.githubusercontent.com/emiliocolor/clientes/62424441a1e4797aa512b11efe3c430ad780f2b5/img_productos_servicios/regalo.png" alt="Bonus de regalo" class="img-fluid rounded mb-2">
                    </div>
                </div>
                <div class="col-md-8">
                    <h5>Bonus de regalo</h5>                    
                    <h6 class="mt-2">Entorno de Desarrollo ClassCloud</h6>
                    <p class="small text-success">GRATIS con la compra del ULTRA MEGA PACK</p>
                    <h6 class="mt-2">Contiene:</h6>
                    <ul class="small">
                        <li>Chat Personal</li>
                        <li>Calendario Inteligente</li>
                        <li>Herramientas Múltiples</li>
                        <li>Organizador de Cursos</li>
                        <li>Integración Google Workspace</li>
                        <li>Plataforma de recursos digitales</li>
                    </ul>
                    <p class="product-price fw-bold mt-2">GRATIS</p>
                    <div class="d-flex gap-2">
                        <a href="https://wa.me/525625377747?text=Hola,%20estoy%20interesado%20en%20el%20Bonus%20de%20regalo%20GRATIS%20de%20EmilioColor®" class="btn btn-success-gradient btn-sm" target="_blank">Solicitar ahora</a>
                    </div>
                </div>
            </div>
        </div>
